...
createFunc:function(script){
    ...
    //This is a big tricky, used GlideController, as GlideEvaluator is causing Memory Leak as per Wobloz.
    //See issue #1 at : https://github.com/abhididdigi/JSON-Scripted-Web-Service/issues/1

    response = GlideController.evaluateString(func);
